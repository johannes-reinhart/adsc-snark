 ...
 *****************************************************************************
 ...
 Provides additional comparision gadgets including:
...
public:
    ...
    limit_gadget(libsnark::protoboard<FieldT>& pb,
            ...
            libsnark::gadget<FieldT>(pb, annotation_prefix), n(n), min(min), max(max), value(value), limited_value(limited_value)
    {
